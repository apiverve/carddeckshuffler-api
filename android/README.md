# Card Deck Shuffler Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:carddeckshuffler-api:1.1.13'
}
```
...
```java
import com.apiverve.carddeckshuffler.CardDeckShufflerAPIClient;
import com.apiverve.carddeckshuffler.APIResponse;
import com.apiverve.carddeckshuffler.APIException;

// Initialize the client
CardDeckShufflerAPIClient client = new CardDeckShufflerAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("decks", 1);
    parameters.put("jokers", true);
    parameters.put("method", "fisher-yates");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/carddeckshuffler](https://docs.apiverve.com/ref/carddeckshuffler)
...
- **Documentation:** [https://docs.apiverve.com/ref/carddeckshuffler](https://docs.apiverve.com/ref/carddeckshuffler)
- **Issues:** [GitHub Issues](https://github.com/apiverve/carddeckshuffler-api/issues)
