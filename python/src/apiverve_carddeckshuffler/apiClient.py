...
class CarddeckshufflerAPIClient:
    ...
    VALIDATION_RULES = {
        "decks": {"type": "integer", "required": False, "min": 1, "max": 10, "default": 1},
        "jokers": {"type": "boolean", "required": False, "default": False},
        "method": {"type": "string", "required": False, "default": "fisher-yates"}
    }
