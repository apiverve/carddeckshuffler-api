...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/carddeckshuffler',
        'Source': 'https://github.com/apiverve/carddeckshuffler-api',
        'Bug Tracker': 'https://github.com/apiverve/carddeckshuffler-api/issues'
    },
    classifiers=[
