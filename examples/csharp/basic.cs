...
{
    class CardDeckShufflerExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/carddeckshuffler";

        /// <summary>
        /// Make a GET request to the Card Deck Shuffler API
        /// </summary>
        static async Task<JsonDocument> CallCardDeckShufflerAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;decks&quot;] &#x3D; 1, [&quot;jokers&quot;] &#x3D; false, [&quot;method&quot;] &#x3D; &quot;fisher-yates&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Card Deck Shuffler API...\n");

            var result = await CallCardDeckShufflerAPI();
