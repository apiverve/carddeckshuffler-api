...
namespace APIVerve.API.CardDeckShuffler
{
    ...
    /// <summary>
    /// Client for the CardDeckShuffler API
    /// </summary>
    public class CardDeckShufflerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/carddeckshuffler";
        ...
        {
            { "decks", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 10 } },
            { "jokers", new ValidationRule { Type = "boolean", Required = false } },
            { "method", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public CardDeckShufflerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CardDeckShufflerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CardDeckShufflerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CardDeckShufflerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CardDeckShufflerQueryOptions options)
        {
        ...
        public ResponseObj Execute(CardDeckShufflerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CardDeckShufflerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CardDeckShufflerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CardDeckShufflerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CardDeckShufflerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CardDeckShufflerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CardDeckShufflerQueryOptions options)
        {
