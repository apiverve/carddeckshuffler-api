...
namespace APIVerve\Carddeckshuffler;
...
/**
 * Client for the Card Deck Shuffler API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/carddeckshuffler?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/carddeckshuffler';
    ...
    private const VALIDATION_RULES = [
        'decks' => ['type' => 'integer', 'required' => false, 'min' => 1, 'max' => 10],
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CarddeckshufflerClient] {$message}\n";
        }
    }
}
