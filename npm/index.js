...
class carddeckshufflerWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/carddeckshuffler');
        }
        ...
        this.validationRules = {"decks":{"type":"integer","required":false,"min":1,"max":10,"default":1},"jokers":{"type":"boolean","required":false,"default":false},"method":{"type":"string","required":false,"default":"fisher-yates"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/carddeckshuffler`);
        }
    }
...
module.exports = carddeckshufflerWrapper;
