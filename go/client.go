...
const (
	baseURL        = "https://api.apiverve.com/v1/carddeckshuffler"
	defaultTimeout = 30 * time.Second
)

// Client is the Card Deck Shuffler API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Card Deck Shuffler API client.
...
// Execute makes a request to the Card Deck Shuffler API with typed parameters.
//
